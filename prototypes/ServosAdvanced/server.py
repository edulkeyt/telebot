...
class MyHandler(CGIHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if command.startswith(SERVO_COMMAND_PARAMETER_NAME):
            ...
            #print("ser.write(bytes([" + anglesStrings[0] + "," + anglesStrings[1] + "," + anglesStrings[2] + "," + anglesStrings[3] + "]));");
            #ser.write(bytes([int(anglesStrings[0]), int(anglesStrings[1]), int(anglesStrings[2]), int(anglesStrings[3])]));
